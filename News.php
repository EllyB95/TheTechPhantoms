				...
				<div class="card news-card">
			        ...
			        <div class="news-card-inner">
			            <div class="card-image">
                    		<div class="responsive-background ">
                    			<div class="image-controller d-block d-sm-none">
                    				<div class="image" style="background-image: url(images/png/1-576x288.png);"></div></div><div class="image-controller d-none d-sm-block"><div class="image" style="background-image: url(images/png/1-768x384.png);">
                    				</div>
                    			</div>
                    		</div>                
                    	</div>
				...
				<div class="card news-card">    
        			...
        			<div class="news-card-inner">
                        <div class="card-image">
		                    <div class="responsive-background ">
		                    	<div class="image-controller d-block d-sm-none">
		                    		<div class="image" style="background-image: url(images/png/1-576x288\ \(1\).png);">
		                    		</div>
		                    	</div>
		                    	<div class="image-controller d-none d-sm-block">
		                    		<div class="image" style="background-image: url(images/png/1-768x384\ \(1\).png);">
		                    		</div>
		                    	</div>
		                    </div>                
		                </div>
				...
				<div class="card news-card">
			        ...
			        <div class="news-card-inner">
                        <div class="card-image">
                    		<div class="responsive-background ">
                    			<div class="image-controller d-block d-sm-none">
                    				<div class="image" style="background-image: url(images/png/2-576x288.png);">
                    				</div>
                    			</div>
                    			<div class="image-controller d-none d-sm-block">
                    				<div class="image" style="background-image: url(images/png/2-768x384.png);">
                    				</div>
                    			</div>
                    		</div>                
                    	</div>
				...
				<div class="card news-card">    
        			...
        			<div class="news-card-inner">
                        <div class="card-image">
                    		<div class="responsive-background ">
                    			<div class="image-controller d-block d-sm-none">
                    				<div class="image" style="background-image: url(images/png/8-576x288.png);">
                    				</div>
                    			</div>
                    			<div class="image-controller d-none d-sm-block">
                    				<div class="image" style="background-image: url(images/png/8-768x384.png);">
                    				</div>
                    			</div>
                    		</div>                
                    	</div>
