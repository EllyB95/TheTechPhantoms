    ...
    <article style="height: 800px">
      <div class="main__container">
        ...
        <table class="content-table">
           ...
           ?>
          <?php while ($row = pg_fetch_array($contacts)) {   ?>
              <tr>
                <td><?php echo $row['cmhauserid'] ?></td>
                <td><?php echo $row['firstname'] ?></td>
                <td><?php echo $row['lastname'] ?></td>
                <td><?php echo $row['emailaddress'] ?></td>
                <td><?php echo $row['phonenumber'] ?></td>
                <td><div class="btn-group" data-toggle="buttons"><a href="Edit.php?cmhauserid=<?php echo $row["cmhauserid"]; ?>" target="_blank" class="btn btn-warning btn-xs"> Edit </a><a href="Delete.php?cmhauserid=<?php echo $row["cmhauserid"]; ?>" target="_blank" class="btn btn-danger btn-xs"> Delete </a></div></td>
              </tr>            
          <?php }   ?>
            </tbody>
          </table>
