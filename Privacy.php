...
<head>
    ...
    <link rel="pingback" ="https://recoverycollegeedmonton.ca/xmlrpc.php">
...
<body class="privacy-policy page-template-default page page-id-44 tribe-no-js">

    <a class="sr-only sr-only-focusable skip-link" href="#skip-anchor">Skip to content</a>

    <!-- Google Tag Manager (noscript) -->
    <noscript>
        <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PLHBZ39"
    ...
    <div id="page" class="site">
            ...
            <div id="cart">
                ...
                <div class="cart-inner">
                    ...
                    <div class="cart-actions">
                        ...
                        <a class="d-none" href="REGISTRATIONPAGEPLACEHOLDER" id="navigate-finalize-registration"></a><!--https://recoverycollegeedmonton.ca/registration/-->
		...
		<div class="sitewide-banner" data-modified="1588200144">
		  <div class="sitewide-banner-container">
		     <h4>CMHA Recovery College classes are now being offered online.</h4><a href="COURSESONLINEPLACEHOLDER" class="button">Register here.</a>
		  </div>
                ...
                <div class="navigation-wrapper">
                    <nav class="primary-nav">
                        ...
                        <ul id="menu-main-menu" class="menu">
                            <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-22" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-22 nav-item"><a title="About Recovery College" href="about.html" class="nav-link">About Recovery College</a></li><!--http://recoverycollegeedmonton.ca/about-recovery-college/-->
                            <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-23" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children dropdown menu-item-23 nav-item">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="menu-item-dropdown-23" role="menu">
                                    <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-24" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-24 nav-item"><a title="All Courses" href="Courses.html" class="dropdown-item">All Courses</a></li><!--http://recoverycollegeedmonton.ca/courses/-->
                                    <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-1994" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1994 nav-item"><a title="Online Classes" href="COURSESONLINEPLACEHOLDER" class="dropdown-item">Online Classes</a></li><!--https://recoverycollegeedmonton.ca/courses/?filter=online-->
                                    <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-25" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-25 nav-item"><a title="Calendar" href="CALENDARPAGEPLACEHOLDER" class="dropdown-item">Calendar</a></li><!--http://recoverycollegeedmonton.ca/events/-->
                                    <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-2175" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2175 nav-item"><a title="Private Courses" href="private-courses.html" class="dropdown-item">Private Courses</a></li><!--https://recoverycollegeedmonton.ca/course/private-courses/-->
                                </ul>
                            </li>
                        </ul>
                    </nav>
                    ...
                    <nav class="utility-nav">
                        <div class="searchform-wrapper">
                            <form class="searchform" method="get" action="#">
                                ...
                                <button aria-labelledby="searchform--5fb22309586ca__label"><span class="iconify" data-icon="bx:bx-search" data-inline="false" ></span><span class="text" id="searchform--5fb22309586ca__label">Search</span></button>
                            </form>
                        ...
                        <ul id="menu-utility-menu" class="menu">
                            <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-19" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-19 nav-item"><a title="News &amp; Updates" href="news.html" class="nav-link">News &#038; Updates</a></li><!--http://recoverycollegeedmonton.ca/news/-->
                            <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-20" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-20 nav-item"><a title="Donate" target="_blank" href="DONATEPLACEHOLDER" class="nav-link">Donate</a></li><!--https://edmonton.cmha.ca/get-involved/donate/-->
                            <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-21" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-21 nav-item"><a title="FAQs" href="FAQPLACEHOLDER" class="nav-link">FAQs</a></li><!--http://recoverycollegeedmonton.ca/faqs/-->
                ...
                <div class="container intro-container">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12">
                            <h2>We take your right to privacy seriously</h2>
                        </div>
            ...
            <section class="dynamic-content ">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12 ">
                            <div class="wysiwyg">
                                <p>Following is the CMHA statement concerning privacy issues on our web site. If you have any questions, comments, or suggestions, please contact us.</p>
                                <ul>
                                    ...
                                    <li>Any personal information you provide to us will not be sold to any third party. We use software that receives and records the Internet Protocol (IP) address of the computer that has contacted our web site. We make no attempt to link these addresses with the identity of individuals contacting our site. The information is used to improve the content of this site and is not shared with other organizations.</li>
                    ...
                    <div class="footer-nav col-6 d-none d-md-block">
                        ...
                        <ul id="menu-footer-menu" class="menu">
                            <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-27" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children dropdown menu-item-27 nav-item">
                                ...
                                <ul role="menu">
                                    <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-28" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-28 nav-item"><a title="All Courses" href="Courses.html" class="dropdown-item">All Courses</a></li><!--http://recoverycollegeedmonton.ca/courses/-->
                                    <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-29" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-29 nav-item"><a title="Calendar" href="CALENDARPAGEPLACEHOLDER" class="dropdown-item">Calendar</a></li><!--http://recoverycollegeedmonton.ca/events/-->
                                </ul>
                            </li>
                            <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-31" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children dropdown menu-item-31 nav-item">
                                ...
                                <ul role="menu">
                                    <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-32" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-32 nav-item"><a title="News &amp; Updates" href="news.html" class="dropdown-item">News &#038; Updates</a></li><!--http://recoverycollegeedmonton.ca/news/-->
                                    <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-33" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-33 nav-item"><a title="FAQs" href="FAQPLACEHOLDER" class="dropdown-item">FAQs</a></li><!--http://recoverycollegeedmonton.ca/faqs/-->
                                </ul>
                            </li>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-4 footer-main-site-link">
                        ...
                        <a href="#" target="_blank">
                            ...
                            <img class="" srcset="images/svg/CMHA_AB_Edmonton_ENG_logo-1.svg 1w, https://recoverycollegeedmonton.ca/wp-content/uploads/sites/3/2019/08/CMHA_AB_Edmonton_ENG_logo-1.svg 1w, https://recoverycollegeedmonton.ca/wp-content/uploads/sites/3/2019/08/CMHA_AB_Edmonton_ENG_logo-1.svg 1w, https://recoverycollegeedmonton.ca/wp-content/uploads/sites/3/2019/08/CMHA_AB_Edmonton_ENG_logo-1.svg 1w" src="https://recoverycollegeedmonton.ca/wp-content/uploads/sites/3/2019/08/CMHA_AB_Edmonton_ENG_logo-1.svg" alt="">
                        </a>
                    </div>
...
/* ]]> */
    ...
    <script type='text/javascript' src='https://recoverycollegeedmonton.ca/wp-content/themes/cmha/assets/dist/bundles/base_script.js?ver=1.7' id='site_scripts-js'></script>
    <script type='text/javascript' id='ajax_scripts-js-extra'>
/* <![CDATA[ */
var ajaxscript = {"ajax_url":"https:\/\/recoverycollegeedmonton.ca\/wp-admin\/admin-ajax.php","home_url":"https:\/\/recoverycollegeedmonton.ca","theme_url":"https:\/\/recoverycollegeedmonton.ca\/wp-content\/themes\/cmha","checkout_url":"https:\/\/recoverycollegeedmonton.ca\/registration\/","nonce":"d15c160d0d"};
/* ]]> */
    </script>
