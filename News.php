...
<body class="archive post-type-archive post-type-archive-news has-sitewide-banner tribe-no-js">
...
<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-23" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children dropdown menu-item-23 nav-item"><a title="Find a Course" href="Courses.php" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle nav-link" id="menu-item-dropdown-23">Courses</a>
</li>
</ul>		</nav>
		...
		<div class="container intro-container">
			<div class="row">
				...
				<div class="col-12 col-md-12">
					<p>For more news & updates about CMHA Edmonton, please visit <a href="https://edmonton.cmha.ca/news/" target="_blank">https://edmonton.cmha.ca/news/</a>.</p>
				</div>
...
<section class="archive archive-news archive-lazy" data-pages="
4">
<!--Search button and field-->
	<div class="container">
		...
		<div class="row">
			<div class="col-12">
				<form class="searchform" method="get" id="news-searchform" action="https://recoverycollegeedmonton.ca/news/">

					<input required type="text" id="news-search" name="s" placeholder="Search news" />
			...
			<div class="row" id="load-more-target">
					...
					<div class="col-12 col-md-6 col-lg-12 news-card-outer">
...
<div class="card news-card">
        ...
        <div class="news-card-inner">
                            ...
                            <div class="card-image">
                    <div class="responsive-background "><div class="image-controller d-block d-sm-none"><div class="image" style="background-image: url(images/png/1-576x288.png);"></div></div><div class="image-controller d-none d-sm-block"><div class="image" style="background-image: url(images/png/1-768x384.png);"></div></div></div>                </div>
            ...
            <div class="card-body">
                ...
                <h3>A Matter of Media and Mental Health</h3>

                <p>The continued stream of news and media stories impact our moods, our and and and ...</p>
...
<div class="card news-card">
        ...
        <div class="news-card-inner">
                            ...
                            <div class="card-image">
                    <div class="responsive-background "><div class="image-controller d-block d-sm-none"><div class="image" style="background-image: url(images/png/1-576x288\ \(1\).png);"></div></div><div class="image-controller d-none d-sm-block"><div class="image" style="background-image: url(images/png/1-768x384\ \(1\).png);"></div></div></div>                </div>
            ...
            <div class="card-body">
                ...
                <h3>Finding Connection and Belonging</h3>

                <p>Exploring thoughts, ideas and sentiments on how to share a social responsibility ...</p>
...
<div class="card news-card">
        ...
        <div class="news-card-inner">
                            ...
                            <div class="card-image">
                    <div class="responsive-background "><div class="image-controller d-block d-sm-none"><div class="image" style="background-image: url(images/png/2-576x288.png);"></div></div><div class="image-controller d-none d-sm-block"><div class="image" style="background-image: url(images/png/2-768x384.png);"></div></div></div>                </div>
            ...
            <div class="card-body">
                ...
                <h3>Helping Shape the Mental Health Space &#8211; Then and Now</h3>

                <p>Achieving impact through collaboration has helped accelerate change in mental to ...</p>
...
<div class="card news-card">
        ...
        <div class="news-card-inner">
                            ...
                            <div class="card-image">
                    <div class="responsive-background "><div class="image-controller d-block d-sm-none"><div class="image" style="background-image: url(images/png/8-576x288.png);"></div></div><div class="image-controller d-none d-sm-block"><div class="image" style="background-image: url(images/png/8-768x384.png);"></div></div></div>                </div>
            ...
            <div class="card-body">
                ...
                <h3>Dear Self: A Loving Reminder</h3>

                <p>Recovery and the journey to wellness starts with honoring the love and respect a ...</p>
