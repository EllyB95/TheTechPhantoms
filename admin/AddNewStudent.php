...
<?php
 $db = pg_connect("sslmode=require sslrootcert=./certificates/ca-certificate.crt host=thetechphantoms-do-user-8660169-0.b.db.ondigitalocean.com port=25060 dbname=Postgres user=CMHA password=j38mp49ya50ow9im");
 if (!$db){  
