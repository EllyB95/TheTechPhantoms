...
<body class="page-template-default page page-id-46 has-sitewide-banner tribe-no-js">
...
<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-23" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children dropdown menu-item-23 nav-item"><a title="Find a Course" href="Courses.php"  aria-haspopup="true" aria-expanded="false" >Find a Course</a>
</li>
</ul>		</nav>
		...
		<div class="container intro-container">
			<div class="row">
				...
				<div class="col-12 col-md-12">
					<h2>Please read these terms of use before using this website.</h2>
				</div>
...
<section class="dynamic-content ">
    ...
    <div class="container">
        <div class="row">
                        ...
                        <div class="wysiwyg">
                            <p><b>Acceptance<br />
</b>The Canadian Mental Health Association Edmonton (“CMHA Edmonton”) provides this website and its services to you subject to the following Terms of Use. Using this website indicates that you fully accept the Terms of Use, without qualification or limitation. If you do not agree with any of the Terms of Use, please do not use this website.</p>
<p><b>Terms May Change<br />
</b>The CMHA Edmonton may change the Terms of Use on occasion without notice, and revised Terms of Use are effective once posted on the website.</p>
<p><b>Copyright and Proprietary Rights<br />
</b>CMHA Edmonton authorizes you to view, copy and print documents published by us on this website for non-commercial use within your home or organization only. In consideration of this authorization, you agree that any copy of these documents shall retain all copyright and proprietary rights and notices contained at the bottom of each page.</p>
<p>You may not use, reuse, repost, distribute, modify, or transmit any information for any commercial purpose or for public use without prior written permission. Prior written permission must be obtained from CMHA Edmonton: Attn: [NTD: Insert Department] #300, 10010-105 Street NW, Edmonton, AB 5J 1C4</p>
<p><b>Trade-Marks<br />
</b>Other product and company names mentioned herein may be subject to trademarks and/or service marks of their respective owners.</p>
<p><b>No Warranties<br />
</b>The information on this website is provided “AS IS” AND “AS AVAILABLE” AND WITHOUT REPRESENTATIONS OR WARRANTY OF ANY KIND, WRITTEN OR ORAL, STATUTORY, EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO, THE IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, ACCURACY AND NONINFRINGEMENT. Some jurisdictions do not allow the exclusion of implied warranties, so the above exclusion may not apply to you.</p>
<p><b>Limitation of Liability<br />
</b>CMHA Edmonton (and our representative officers, directors, employees and representatives) shall not under any circumstances be liable to you or any other party for any damages of any kind, including, special, incidental, indirect or direct, or consequential damages, including, without limitation, damages resulting from use of OR RELIANCE ON the information presented on this website, loss of profits or revenues or costs of replacement goods, even when informed in advance of the possibility of such damages. Your sole and exclusive remedy is to discontinue using and accessing the website.</p>
<p>You release CMHA Edmonton and its officers, directors, employees and representatives from all claims, actions, liabilities and damages of any kind relating to or arising from your access to and use of (or your inability to access and use) the website or its content.</p>
<p><b>Content<br />
</b>Every effort has been made to ensure the accuracy of the information presented on this website. However, CMHA Edmonton assumes no responsibility for the accuracy or completeness of the information. CMHA Edmonton may make improvements and/or changes to this website at any time without notice.</p>
<p>Information on this website is not intended to provide specific technical, personal, legal, business, or other advice for your individual circumstances.</p>
<p><b>Links<br />
</b>Any sites that are linked to or from our website are not under our control, and you access them at your own risk. We do not assume any responsibility or liability for these linked sites or their contents. We provide all such links for your convenience only; they are not an endorsement or referral by us.</p>
<p><b>Privacy Policy<br />
</b>Following is the CMHA Edmonton statement concerning privacy issues on our website. If you have any questions, comments, or suggestions, please contact us.</p>
<ul>
<li>We respect your personal privacy.</li>
<li>We do not automatically gather any personal information such as your name, phone number, e-mail or address. This information is only obtained if you supply it voluntarily, through contacting us via e-mail, by asking to be added to an Information Network or to receive electronic newsletters or other information.</li>
<li>Any personal information you provide to us will not be sold to any third party. We use software that receives and records the Internet Protocol (IP) address of the computer that has contacted our website. We make no attempt to link these addresses with the identity of individuals contacting our site. The information is used to improve the content of this site and is not shared with other organizations.</li>
<li>We do not regularly use “cookies” to track how our visitors use the site. Whenever we enable “cookies” to facilitate our transactions, we will first inform you.</li>
<li>If you choose to participate in an on-line forum or discussion group or join an Information Network or similar list, we may ask you to volunteer personal information such as your name and e-mail address for the purposes of effective administration of the forum or discussion group. We will not disclose this information to anyone outside of CMHA Edmonton without your prior consent.</li>
</ul>
<p><b>Security and Viruses<br />
</b>E-mail communications between you and us may not be secure, and we suggest that you encrypt all e-mail to increase the security of your communications with us. Due to the inherent open nature of the Internet, we cannot guarantee that communications between you and us will be free from unauthorized access by third parties such as hackers, and your use of our Site demonstrates your assumption of this risk.</p>
<p>We have taken steps to ensure that the website is free of computer viruses and other harmful components. Nevertheless, you should install and maintain appropriate anti-virus and other protective software on the devices from which you access and use the website. Without limiting any other part of these Terms of Use, we disclaim all liability for any computer viruses or other harmful or destructive programs that you may download from the website.</p>
<p><b>Indemnification<br />
</b>You agree to indemnify and hold harmless CMHA Edmonton and its directors, officers, employees and representatives from and against all losses, expenses, damages and costs (including actual legal expenses as billed) resulting directly or indirectly from any violation of these Terms of Use or any activity of yours related to the website.</p>
<p><b>Jurisdiction<br />
</b>These Terms of Use, your access to and use of the website and the content, and any claims made against CMHA Edmonton or its directors, officers, employees and representatives, arising out of such access or use or otherwise, will be governed by and construed and interpreted in accordance with Alberta laws.</p>
<p>You agree that jurisdiction and venue in any legal proceeding directly or indirectly arising out of or relating to the website will be in the Alberta courts.</p>
<p><b>General<br />
</b>If any part of these Terms of Use is unlawful, void or unenforceable, then that part is severable and will not affect the validity and enforceability of the remaining Terms of Use.</p>
<p><strong>Disclaimer</strong><br />
This site provides general information only and may or may not reflect the position of the Canadian Mental Health Association (CMHA). Information provided is not a substitute for professional advice. If you feel that you may need medical advice, please consult a qualified health care professional. CMHA makes every reasonable effort to ensure that the information is accurate at the time of posting. We cannot guarantee the reliability of any information posted.</p>
                        </div>
                    </div>
...
<!--Made a change to srcset (made it local)-->
			<div class="row">
