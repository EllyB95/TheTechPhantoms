    ...
    <div class="navigation-wrapper">
        <nav class="primary-nav">
            <ul id="menu-main-menu" class="menu">
                <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-23" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children dropdown menu-item-23 nav-item"><a title="About Recovery College" href="about.php" class="nav-link" >About Recovery College</a></li>
            </ul>       
        </nav>
        ...
        <div class="container intro-container">
            <div class="row">
                ...
                <div class="col-12 col-md-12">
                    <h3>Find All Courses here. </h3>
                   <p>Register for an course or get more information in our course catalogue.
                            </p>
                </div>
