...
echo "<center><h1>Doesn't work =(</h1></center>";  
 ...
 if(isset($_POST['reset'])&&!empty($_POST['reset'])){
    ...
    $sql ="select * from public.sub_admin where email = '".pg_escape_string($_POST['email'])."' and mobile_no ='".pg_escape_string($_POST['mobile_no'])."'";
      ...
      //  console.log("testing3");
        ...
        //$_SESSION["EmailSubAdmin"] = $_POST['email'];
            ...
            if($ret){
                    ...
                    echo "<script>setTimeout(\"location.href = 'SubAdminLogin.php';\",1);</script>";
       ...
       // header('Location: SubAdminLogin.php');    
        ...
        //console.log("testing4");
         echo '<script>alert("Invalid Mobile Number for Entered Email")</script>';
    ...
    <div class="navigation-wrapper">
        ...
        <nav class="utility-nav">
            <div class="searchform-wrapper">
                <form class="searchform" method="get" action="../HomePageAdmin.php">
