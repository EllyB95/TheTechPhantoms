...
<div class="header header-simple">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group <?php echo (!empty($emailaddress_err)) ? 'has-error' : ''; ?>">
                ...
                <input type="text" name="emailaddress" class="form-control" value="<?php echo $emailaddress; ?>">
            ...
            <div>
                ...
                <input type="text" name="indigenousidentity" class="form-control" value="<?php echo $indigenousidentity; ?>">
                <span class="help-block"></span>
            </div> 
            <div>
                <label>languagespoken</label>
                <input type="text" name="languagespoken" class="form-control" value="<?php echo $languagespoken; ?>">
                <span class="help-block"></span>
            </div> 
            <div>
                <label>housingstatus</label>
                <input type="text" name="housingstatus" class="form-control" value="<?php echo $housingstatus; ?>">
                <span class="help-block"></span>
            </div> 
            <div>
                <label>sourceofincome</label>
                <input type="text" name="sourceofincome" class="form-control" value="<?php echo $sourceofincome; ?>">
                <span class="help-block"></span>
            </div> 
            <div>
                <label>occupation</label>
                <input type="text" name="occupation" class="form-control" value="<?php echo $sourceoccupationofincome; ?>">
                <span class="help-block"></span>
            </div>
