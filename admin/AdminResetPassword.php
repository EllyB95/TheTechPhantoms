...
echo "<center><h1>Doesn't work =(</h1></center>";  
 ...
 if(isset($_POST['reset'])&&!empty($_POST['reset'])){
    ...
    $sql ="select * from public.admin where email = '".pg_escape_string($_POST['email'])."' and mobile_no ='".pg_escape_string($_POST['mobile_no'])."'";
      ...
      //  console.log("testing3");
        ...
        //$_SESSION["EmailAdmin"] = $_POST['email'];
            ...
            if($ret){
                    ...
                    echo "<script>setTimeout(\"location.href = 'AdminLogin.php';\",1);</script>";
