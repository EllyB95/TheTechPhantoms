...
<ul class="dropdown-menu" aria-labelledby="menu-item-dropdown-23" role="menu">
	...
	<button aria-labelledby="searchform--5fc13555b0a55__label"><i class="ion ion-md-search"></i><span class="text" id="searchform--5fc13555b0a55__label">Search</span></button>
</form>
